...
--===================================================================================
XNL_UseRedBarWhenLosingXP = false    -- This sets if the bar should turn red when a player is LOSING XP (due to an admin 'punishment' for example!)
XNL_MaxPlayerLevel = 5000            -- Sets the maximum level (Maximum which can be used is 7999!)
-- This will also prevent the player from getting more XP than possible
-- IF you use my variable to set/read the player XP
XNL_EnableZKeyForRankbar = false      -- This Enables/Disables (when you set it to false) the Rankbar showing up when the player presses Z on the keyboard
...
RegisterKeyMapping("level", "Afficher votre level", "keyboard", "X")
...
--===================================================================================
_RegisterNetEvent("XNL_NET:XNL_SetInitialXPLevels")
_AddEventHandler("XNL_NET:XNL_SetInitialXPLevels", function(NetCurrentXP, NetShowRankBar, NetShowRankBarAnimating)
    XNL_SetInitialXPLevels(NetCurrentXP, NetShowRankBar, NetShowRankBarAnimating)
end)

_RegisterNetEvent("XNL_NET:AddPlayerXP")
_AddEventHandler("XNL_NET:AddPlayerXP", function(NetXPAmmount)
    XNL_AddPlayerXP(NetXPAmmount)
end)

_RegisterNetEvent("XNL_NET:RemovePlayerXP")
_AddEventHandler("XNL_NET:RemovePlayerXP", function(NetXPAmmount)
